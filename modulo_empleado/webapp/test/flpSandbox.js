		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#lorkgroupmoduloempleado-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"lorkgroupmoduloempleado-display": {
								"semanticObject": "lorkgroupmoduloempleado",
								"action": "display",
								"description": "Grupo Lork",
								"title": "Aplicacion Empleados",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=lorkgroup.moduloempleado",
									"url": sap.ui.require.toUrl("lorkgroup/moduloempleado")
								}
							}
						}
					}
