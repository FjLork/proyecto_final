sap.ui.define([
    ...
    return Controller.extend("lorkgroup.moduloempleado.controller.CrearEmpleado.CrearEmpleado", {
		...
		onInit: function () {
			...
			this.model.setProperty("/UserType", "Mobile");
		...
		additionalInfoValidation: function () {
			var name = this.byId("UserFirstName").getValue();
			var weight = parseInt(this.byId("UserLastName").getValue());
			...
			if (isNaN(weight)) {
				...
				this.model.setProperty("/UserLastName", "None");
			...
			// } else {
			// 	this.model.setProperty("/UserFirstName", "None");
			// }
