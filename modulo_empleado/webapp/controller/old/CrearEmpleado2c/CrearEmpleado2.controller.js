sap.ui.define([
    ...
    "sap/m/MessageToast",
    "sap/ui/model/json/JSONModel",                                          // Importar JSONModel
    ...
    "lorkgroup/moduloempleado/controller/CrearEmpleado2/GestionForm"       // Importa el módulo para manejar el formulario
], function (Controller, MessageToast, JSONModel, Validacion, GuardarDatos, GestionForm) {
    "use strict";
    ...
    return Controller.extend("lorkgroup.moduloempleado.controller.CrearEmpleado2.CrearEmpleado2", {
        ...
        _LoadUser: function () {
            let oModelUsers = new sap.ui.model.json.JSONModel();
            oModelUsers.loadData("webapp/model/Users.json");  // Ajusta la ruta si es necesario
        
            oModelUsers.attachRequestCompleted(function() {
                console.log("Datos de usuario cargados:", oModelUsers.getData());
                this.getView().setModel(oModelUsers, "jsonUsers");
            }.bind(this));
        },
        ...
        TypeFrom: function (oEvent) {
            ...
            if (GestionForm && typeof GestionForm.TypeFrom === 'function') {
                GestionForm.TypeFrom.call(this, oEvent);
            } else {
                console.error("La función TypeFrom.");
            }
        }
